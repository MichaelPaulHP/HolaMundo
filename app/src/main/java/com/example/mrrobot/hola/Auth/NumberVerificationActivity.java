...
import com.example.mrrobot.hola.MainActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationFailed(FirebaseException e) {
                Toast.makeText(NumberVerificationActivity.this,"Sign failed¡",Toast.LENGTH_SHORT).show();
            }
            @Override
            public void onCodeSent(String verificationId,
                ...
                mResendToken = token;
                Toast.makeText(NumberVerificationActivity.this,"Codigo Verificado",Toast.LENGTH_SHORT).show();
            }
        };
        ...
        btnEnviar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(NumberVerificationActivity.this,""+cPhoneNumber,Toast.LENGTH_SHORT).show();
                ...
                Toast.makeText(NumberVerificationActivity.this,"Se ha enviado la solicitud",Toast.LENGTH_SHORT).show();
            }
        });
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Intent iMainActivity=new Intent(NumberVerificationActivity.this, MainActivity.class);
                            ...
                            if (task.getException() instanceof FirebaseAuthInvalidCredentialsException) {
                                ...
                                Toast.makeText(NumberVerificationActivity.this,"Code Invalid¡",Toast.LENGTH_SHORT).show();
                            }
